...
namespace Sprint_1_Pitigala
{
    public partial class Form2 : Form
    {
        ...
        private void btnGroupInsertClear_Click(object sender, EventArgs e)
        {
            Clearmethod();
        }

        private void comboPrg_SelectedIndexChanged(object sender, EventArgs e)
        {
